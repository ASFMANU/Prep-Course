...
function suma(x, y) {
  ...
  // Tu código:
      var result= x+y;
        if(isNaN(result)) {
        console.log("Los numeros ingresados no son correctos");
      }
      else {
...
function resta(x, y) {
  ...
  var result= x-y;
        ...
        console.log("La Resta es igual a => " + result);
      } 
      return result;
}
...
function multiplica(x, y) {
  ...
  var result= x*y;
        ...
        console.log("La Multiplicación es igual a => " + result);
      }
      return result;
}
...
function divide(x, y) {
  ...
  var result= x/y;
        ...
        console.log("La división es igual a => " + result);
      }
      return result;
}
...
function sonIguales(x, y) {
  ...
  if (isNaN(result)){
    ...
    console.log("La igualdad es: "+ result)
  }
  return result;
}
...
function tienenMismaLongitud(str1, str2) {
  ...
  if (isNaN(result)){
    ...
    console.log("La igualdad de la longitud es: "+ result)
  }
  return result;
